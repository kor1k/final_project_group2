...
-- insert into PROFILES values (1 , 3000 , 1);
-- insert into PROFILES values (2 , 2874 , 2);
-- insert into EDUCATIONS values (0001 , 'master' , 'no description yet' , 18-06-2008 , 'NTUU "KPI"' , false , 'Economics' , 01-09-2002 , 1);
-- insert into EDUCATIONS values (0001 , 'master' , 'no description yet' , 18-06-2014 , 'NTUU "KPI"' , false , 'Astrophisics' , 01-09-2008 , 2);
